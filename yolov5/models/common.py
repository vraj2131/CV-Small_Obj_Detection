...
class C3SPP(C3):
    """C3 + SPP alias stub so that imports of C3SPP don’t break."""
    pass

class C3TR(C3):
    """alias so configs importing C3TR won’t break."""
    pass
class SPP(nn.Module):
...
class SPPF(SPP):
    """alias so configs importing SPPF won’t break."""
    pass
class C3Ghost(C3):
    """alias so configs importing SPPF won’t break."""
    pass
...
class CrossConv(Conv):
    """alias so ffca_yolo.yaml’s CrossConv layers won’t break."""
    pass

import torch.nn as nn

class DetectMultiBackend(nn.Module):
    """alias so old code importing DetectMultiBackend doesn’t break."""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, *args, **kwargs):
        raise NotImplementedError("DetectMultiBackend stub — only for import.")
...
def init_rate_0(tensor):
    if tensor is not None:
        tensor.data.fill_(0.)
# Stub for Conv_withoutBN
class Conv_withoutBN(nn.Module):
    """Stub so that `from models.common import Conv_withoutBN` succeeds."""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
...
class C2f(nn.Module):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("C2f is a stub and should not be called at runtime")

# Stub for C3_Faster
class C3_Faster(nn.Module):
    """Stub so that `from models.common import C3_Faster` succeeds."""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("C3_Faster is a stub and should not be called at runtime")

# Stub for SCAM
class SCAM(nn.Module):
    """Stub so that `from models.common import SCAM` succeeds."""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("SCAM is a stub and should not be called at runtime")



class Conv_withoutBN(nn.Module):
    """alias stub so 'from models.common import Conv_withoutBN' works"""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("Conv_withoutBN is a stub and should not be called at runtime")
class Proto(nn.Module):
    """alias stub so 'from models.common import Proto' works"""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("Proto is a stub and should not be called at runtime")
class GhostConv(nn.Module):
    """alias stub so 'from models.common import GhostConv' works"""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("GhostConv is a stub and should not be called at runtime")
class DWConvTranspose2d(nn.Module):
    """alias stub so 'from models.common import DWConvTranspose2d' works"""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("DWConvTranspose2d is a stub and should not be called at runtime")
class GhostBottleneck(nn.Module):
    """alias stub so 'from models.common import GhostBottleneck' works"""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("GhostBottleneck is a stub and should not be called at runtime")
        
class FFM_Concat2(nn.Module):
    """alias stub so 'from models.common import FFM_Concat2' works"""
    def __init__(self, *args, **kwargs):
        super().__init__()
    def forward(self, x):
        raise NotImplementedError("FFM_Concat2 is a stub and should not be called at runtime")
